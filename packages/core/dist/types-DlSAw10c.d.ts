//#region ../element_attributes/dist/index.d.ts
declare namespace ElementAttributes {
  /**
...
type SpecialAttributes<ClassAttribute = string | string[] | {
  [className: string]: boolean;
}, StyleAttribute = string | Partial<CSSStyleDeclaration>, DataAttribute = DOMStringMap, Children = (Child | Child[])[]> = {
  /**
...
type PrefixedSVGElementTagNameMap = {
  'svg': 'svg';
} & { [K in keyof Omit<SVGElementTagNameMap, 'svg'> as `svg:${K}`]: K };
type PrefixedMathMLElementTagNameMap = {
  'math': 'math';
} & { [K in keyof Omit<MathMLElementTagNameMap, 'math'> as `math:${K}`]: K };
type PrefixedElementTag = keyof HTMLElementTagNameMap | keyof HTMLElementDeprecatedTagNameMap | keyof PrefixedSVGElementTagNameMap | keyof PrefixedMathMLElementTagNameMap;
type BaseElementAttributes<T extends PrefixedElementTag> = (T extends keyof PrefixedSVGElementTagNameMap ? ElementAttributes.SVGElementTagNameMap[PrefixedSVGElementTagNameMap[T]] : T extends keyof PrefixedMathMLElementTagNameMap ? ElementAttributes.MathMLElementTagNameMap[PrefixedMathMLElementTagNameMap[T]] : T extends keyof HTMLElementTagNameMap ? ElementAttributes.HTMLElementTagNameMap[T] : T extends keyof HTMLElementDeprecatedTagNameMap ? ElementAttributes.HTMLElementDeprecatedTagNameMap[T] : never) & Readonly<Record<string | symbol, unknown>>;
type ElementAttributes$1<T extends PrefixedElementTag> = Partial<BaseElementAttributes<T> & SpecialAttributes>;
type ElementFromPrefixedTag<T extends PrefixedElementTag> = T extends keyof PrefixedSVGElementTagNameMap ? SVGElementTagNameMap[PrefixedSVGElementTagNameMap[T]] : T extends keyof PrefixedMathMLElementTagNameMap ? MathMLElementTagNameMap[PrefixedMathMLElementTagNameMap[T]] : T extends keyof HTMLElementTagNameMap ? HTMLElementTagNameMap[T] : T extends keyof HTMLElementDeprecatedTagNameMap ? HTMLElementDeprecatedTagNameMap[T] : never;
//#endregion
export { PrefixedElementTag as a, ElementFromPrefixedTag as i, Child as n, SpecialAttributes as o, ElementAttributes$1 as r, BaseElementAttributes as t };
//# sourceMappingURL=types-DlSAw10c.d.ts.map